...
@Component
public class PaymentFinishWorker implements CommandLineRunner {
    ...
    public PaymentFinishWorker(ExternalTaskClient externalTaskClient, RestTemplate restTemplate) {
    ...
    public void run(String... args) throws Exception {
        externalTaskClient.subscribe("payment-finishing")
                .handler(this::finishPayment).open();

    }

    private void finishPayment(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        ...
        variables.put("paymentOk", fromVariableTyped(externalTask.getVariableTyped("paymentOk")));

        messageRequestDto.setBusinessKey(externalTask.getVariable("orderId"));
        messageRequestDto.setMessageName("PaymentReceivedMessage");
